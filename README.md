...
- [Challenges](#challenges)
  - [1. 사용성 테스트](#1-사용성-테스트)
    ...
    - [1-2 UX KPI 통계화 하기](#1-2-ux-kpi-통계화-하기)
...
UXPlorer의 관건은 얼마나 재미있고 유용한 데이터를 모을 수 있느냐였습니다. 이러한 데이터는 사용자에게 더욱 도움이 되는 요소라 생각했습니다. 이를 위해 MongoDB의 스키마 설계 시 Embedded 방식과 Reference 방식을 비교해 볼 필요가 있었습니다.
...
테스터는 이메일로 부여받은 테스트 ID 및 비밀번호를 사용하여 테스트 환경에 진입할 수 있게 설계해야 했습니다. 이를 위해 웰컴 모달을 활용하여 현재 진행될 테스트에 대한 설명을 해주었습니다.
